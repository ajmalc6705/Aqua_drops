...
patch(SearchPanel.prototype, "imazighen_web_enterprise.SearchPanel", {
    setup() {
...
patch(SearchPanel, "imazighen_web_enterprise.SearchPanel", {
    template: "imazighen_web_enterprise.SearchPanel",
    components: {
