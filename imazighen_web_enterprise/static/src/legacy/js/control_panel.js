odoo.define('imazighen_web_enterprise.ControlPanel', function (require) {
    "use strict";
     ...
     */
    patch(ControlPanel.prototype, 'imazighen_web_enterprise.ControlPanel', {
        setup() {
    ...
    patch(ControlPanel, 'imazighen_web_enterprise.ControlPanel', {
        template: 'imazighen_web_enterprise._ControlPanel',
        components: {
