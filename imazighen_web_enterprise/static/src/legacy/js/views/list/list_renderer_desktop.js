odoo.define('imazighen_web_enterprise.ListRenderer', function (require) {
    "use strict";
    ...
    const PromoteStudioDialog = require('imazighen_web_enterprise.PromoteStudioDialog');
    ...
    ListRenderer.include({
        ...
        _renderOptionalColumnsDropdown: function () {
            ...
            if (session.is_system) {
                ...
                const $addCustomField = $(qweb.render('imazighen_web_enterprise.open_studio_button'));
