odoo.define("web.SearchPanelMobile", function (require) {
    ...
    patch(SearchPanel.prototype, "imazighen_web_enterprise.SearchPanel.Mobile", {
        setup() {
    ...
    patch(SearchPanel, "imazighen_web_enterprise.SearchPanel.Mobile", {
        template: "imazighen_web_enterprise.Legacy.SearchPanel.Mobile",
        components: {
